...
//!
//! **ONNX Spec**: <https://onnx.ai/onnx/operators/onnx__BlackmanWindow.html>
//!
//! ## Opset Versions
...
const OP_NAME: &str = "BlackmanWindow";

/// Configuration for the BlackmanWindow operation.
#[derive(Debug, Clone)]
pub struct BlackmanWindowConfig {
...
impl Default for BlackmanWindowConfig {
    fn default() -> Self {
        Self {
            periodic: true,
...
/// Node representation for BlackmanWindow operation.
#[derive(Debug, Clone, NodeBuilder)]
pub struct BlackmanWindowNode {
    pub name: String,
    pub inputs: Vec<Argument>,
    pub outputs: Vec<Argument>,
    pub config: BlackmanWindowConfig,
}

pub(crate) struct BlackmanWindowProcessor;

impl NodeProcessor for BlackmanWindowProcessor {
    type Config = BlackmanWindowConfig;
    ...
    fn infer_types(
        ...
        // Validate input shape is scalar-like (dtype is checked below).
...
mod tests {
    ...
    #[test]
    fn test_blackman_window_default() {
        let mut node = TestNodeBuilder::new(NodeType::BlackmanWindow, "test_blackman")
            .input_scalar_tensor_i64("size", Some(10))
            .output_tensor_f32("output", 0, None)
            .build_with_graph_data(17);

        let processor = BlackmanWindowProcessor;
    ...
    #[test]
    fn test_blackman_window_double_output() {
        let mut node = TestNodeBuilder::new(NodeType::BlackmanWindow, "test_blackman")
    ...
    fn test_blackman_window_symmetric() {
        let node = TestNodeBuilder::new(NodeType::BlackmanWindow, "test_blackman")
            .input_scalar_tensor_i64("size", Some(10))
            .output_tensor_f32("output", 0, None)
            .attr_int("periodic", 0)
            .build_with_graph_data(17);
    ...
    #[test]
    fn test_blackman_window_runtime_size() {
        let mut node = TestNodeBuilder::new(NodeType::BlackmanWindow, "test_blackman")
    ...
    #[test]
    fn test_blackman_window_i32_input_runtime() {
    ...
    #[test]
    fn test_blackman_window_float_input_rejected() {
        let mut node = TestNodeBuilder::new(NodeType::BlackmanWindow, "test_blackman")
    ...
    #[test]
    fn test_blackman_window_negative_size() {
        let mut node = TestNodeBuilder::new(NodeType::BlackmanWindow, "test_blackman")
    ...
    #[test]
    fn test_blackman_window_integer_output_dtype_rejected() {
        let mut node = TestNodeBuilder::new(NodeType::BlackmanWindow, "test_blackman")
            .input_scalar_tensor_i64("size", Some(10))
            .output_tensor_f32("output", 0, None)
    ...
    #[test]
    fn test_blackman_window_opset_too_low() {
        let mut node = TestNodeBuilder::new(NodeType::BlackmanWindow, "test_blackman")
            .input_scalar_tensor_i64("size", Some(10))
            .output_tensor_f32("output", 0, None)
