...
def download_and_convert_model(model_name, output_path):
    """Download SmolLM2 model from HuggingFace and export to ONNX format."""
    import torch
...
def main():
    parser = argparse.ArgumentParser(description='SmolLM2 Model Preparation Tool')
    parser.add_argument('--model', type=str, default='smollm2-135m',
                        choices=list(SUPPORTED_MODELS.keys()),
                        help=f'SmolLM2 model to download and prepare (default: smollm2-135m)')
    ...
    if args.list:
        print("Supported SmolLM2 models:")
    ...
    artifacts_dir = get_artifacts_dir("smollm2")
