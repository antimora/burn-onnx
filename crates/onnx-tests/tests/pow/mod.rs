...
mod tests {
    ...
    fn pow_broadcast() {
        ...
        let expected1 = TensorData::from([
            [[2.0f32, 4.0, 8.0, 16.0], [2.0, 4.0, 8.0, 16.0], [2.0, 4.0, 8.0, 16.0]],
            [[2.0, 4.0, 8.0, 16.0], [2.0, 4.0, 8.0, 16.0], [2.0, 4.0, 8.0, 16.0]],
        ]);

        // result2: [1,2,3,4]^2 = [1, 4, 9, 16]
        let expected2 = TensorData::from([
            [[1.0f32, 4.0, 9.0, 16.0], [1.0, 4.0, 9.0, 16.0], [1.0, 4.0, 9.0, 16.0]],
            [[1.0, 4.0, 9.0, 16.0], [1.0, 4.0, 9.0, 16.0], [1.0, 4.0, 9.0, 16.0]],
        ]);
